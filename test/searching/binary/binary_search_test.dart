...
void main() {
  group('binarySearch()', () {
    ...
    group('Find items with start, count and a comparator', () {
      var arr = List<int>.generate(100, (i) => (i / 10).floor());
      final comp = ((int a, int b) => a - b);
      test("arr, 1, start: 8, count: 0, compare: comp", () {
        expect(binarySearch(arr, 1, start: 8, count: 0, compare: comp), -1);
      });
      test("arr, 1, start: 8, count: 1, compare: comp", () {
        expect(binarySearch(arr, 1, start: 8, count: 1, compare: comp), -1);
      });
      test("arr, 1, start: 8, count: 2, compare: comp", () {
        expect(binarySearch(arr, 1, start: 8, count: 2, compare: comp), -1);
      });
      test("arr, 1, start: 8, count: 3, compare: comp", () {
        expect(binarySearch(arr, 1, start: 8, count: 3, compare: comp), 10);
      });
      test("arr, 1, start: 10, count: 0, compare: comp", () {
        expect(binarySearch(arr, 1, start: 10, count: 0, compare: comp), -1);
      });
      ...
      test("arr, 0, start: -30, count: 1, compare: comp", () {
        expect(binarySearch(arr, 0, start: -30, count: 1, compare: comp), -1);
      });
      test("arr, 0, start: -30, count: 30, compare: comp", () {
        expect(binarySearch(arr, 0, start: -30, count: 30, compare: comp), -1);
      });
      test("arr, 0, start: -30, count: 31, compare: comp", () {
        expect(binarySearch(arr, 0, start: -30, count: 31, compare: comp), 0);
      });
      test("arr, 1, start: -30, count: 40, compare: comp", () {
        expect(binarySearch(arr, 1, start: -30, count: 40, compare: comp), -1);
      });
      test("arr, 1, start: -30, count: 41, compare: comp", () {
        expect(binarySearch(arr, 1, start: -30, count: 41, compare: comp), 10);
      });
    });
  });
}
