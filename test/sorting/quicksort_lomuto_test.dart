  ...
  group("quickSortLomuto()", () {
    test("Test all permutations of [-3, -2, -1, 0, 1, 2] with threshold: 0",
      ...
      for (final list in perms()) {
        quickSortLomuto(list, threshold: 0);
    ...
    test(
      ...
      final perms = Permutations(original.length, original);
      for (final list in perms()) {
        quickSortLomuto(list, threshold: 128);
        expect(list, original);
      }
    });
    ...
    test("Test single element list", () {
      final list = [-2];
      quickSortLomuto(list, threshold: 2);
    ...
    group("Test partial sorting", () {
      test("Case: begin at -10", () {
        ...
        quickSortLomuto(list, begin: -10, threshold: 2);
        expect(list, [1, 2, 3, 3, 7, 8]);
      });
      test("Case: begin at 2", () {
        final list = [8, 1, 3, 7, 3, 2];
        quickSortLomuto(list, begin: 2, threshold: 2);
        expect(list, [8, 1, 2, 3, 3, 7]);
      });
      test("Case: begin at 5", () {
        final list = [8, 1, 3, 7, 3, 2];
        quickSortLomuto(list, begin: 5, threshold: 0);
        expect(list, [8, 1, 3, 7, 3, 2]);
      });
      test("Case: begin at 10", () {
        final list = [8, 1, 3, 7, 3, 2];
        quickSortLomuto(list, begin: 10, threshold: 0);
        expect(list, [8, 1, 3, 7, 3, 2]);
      });

      test("Case: end at -10", () {
        final list = [8, 1, 3, 7, 3, 2];
        quickSortLomuto(list, end: -10, threshold: 0);
        expect(list, [8, 1, 3, 7, 3, 2]);
      });
      test("Case: end at -2", () {
        final list = [8, 1, 3, 7, 3, 2];
        quickSortLomuto(list, end: -2, threshold: 0);
      ...
      test("Case: end at 5", () {
        final list = [8, 1, 3, 7, 3, 2];
        quickSortLomuto(list, end: 5, threshold: 0);
      ...
      test("Case: begin at -10 end at -10", () {
        final list = [8, 1, 3, 7, 3, 2];
        quickSortLomuto(list, begin: -10, end: -10, threshold: 0);
        expect(list, [8, 1, 3, 7, 3, 2]);
      });
      test("Case: begin at -10 end at 2", () {
        final list = [8, 1, 3, 7, 3, 2];
        quickSortLomuto(list, begin: -10, end: 2, threshold: 0);
        expect(list, [1, 8, 3, 7, 3, 2]);
      });
      test("Case: begin at 2 end at -1", () {
        final list = [8, 1, 3, 7, 3, 2];
        quickSortLomuto(list, begin: 2, end: -1, threshold: 0);
        expect(list, [8, 1, 3, 3, 7, 2]);
      });
      test("Case: begin at 2 end at 2", () {
        final list = [8, 1, 3, 7, 3, 2];
        quickSortLomuto(list, begin: 2, end: 2, threshold: 0);
        expect(list, [8, 1, 3, 7, 3, 2]);
      });
      ...
      test("Case: begin at -3 end at -1", () {
        final list = [8, 1, 3, 7, 3, 2];
        quickSortLomuto(list, begin: -3, end: -1, threshold: 0);
        expect(list, [1, 3, 3, 7, 8, 2]);
      });
    });
  });

  group("quickSortLomuto() with custom [compare]", () {
    final comp = ((int a, int b) => b - a);
    test("Test all permutations of [2, 1, 0, -1, -2, -3]", () {
      final original = [2, 1, 0, -1, -2, -3];
      final perms = Permutations(original.length, original);
      for (final list in perms()) {
        quickSortLomuto(list, compare: comp, threshold: 2);
        expect(list, original);
      }
    });
    test(
      ...
      final perms = Permutations(original.length, original);
      for (final list in perms()) {
        quickSortLomuto(list, compare: comp, threshold: 128);
        expect(list, original);
      }
    });
    test("Test with large list of 1000 length", () {
